...
- **ADR mapping**：follow ADR-020/025/028。Resource owner 保留 payload/profile/carrier/preview/apply/receipt/repository lifecycle；platform 只交付 rooted/publish facts 与普通 bundle 布局。source 成果保留原范围，普通候选按下列依赖验收。
