...
- [x] 1. 建立术语 preview 合同与 Foundation capability
- [x] 1.1 冻结有界 preview DTO 与 capability
...
- [x] 1.2 扩展 registry pinned preview behavior
...
- [x] 1.3 在唯一 Application surface 编排 sealed preview
...
- [x] 2. 实现 CSV/XLSX codec-owned 列 preview
- [x] 2.1 实现 CSV 首行 preview
...
- [x] 2.2 实现 XLSX active-sheet preview
...
- [x] 3. 闭合 Application/Controller 显式选择与 stale gate
- [x] 3.1 增加 Qt-safe preview/selection contracts
...
- [x] 3.2 扩展 resource importer preview与显式 staging
...
- [x] 3.3 增加 Controller preview command并保持事务
...
- [x] 4. 实现 Qt 异步 preview 与列选择对话
- [x] 4.1 增加 preview worker与busy lifecycle
...
- [x] 5.2 执行 fresh completion并同步真实Steering
