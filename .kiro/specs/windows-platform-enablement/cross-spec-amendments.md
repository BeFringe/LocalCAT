...
| WA-04 | `R1` | `language-resource-portability` | `ACKNOWLEDGED` | `SOURCE_COMMITTED` |
| WA-05 | `R1` | `tmx-context-interchange` | `ACKNOWLEDGED` | `SOURCE_COMMITTED` |
...
| WA-02 | `R1` | `collaborative-job-chunks` | `a0cde80aa18958b60490f60d6f0a56f24821e68b` (`1.3a/1.4a/3.2a`); `91b0039651401113175c9ed5b17fcd4fcd57e4cc` (real ProjectPackage application-edge prerequisite); `9abd9e1a5942ddffa0dad24a4d41e0f863d57ff1` (`4.4a/4.5a` completion) | `9abd9e1a5942ddffa0dad24a4d41e0f863d57ff1` | `SOURCE_MERGED_PASS` | `artifacts/windows/c4s-wa02-startup/a0cde80/evidence-manifest.json` / `d68561c1abc061528ecfc503d7c5d0d395cf8881a64425f00ccd6d200dad2157`; `artifacts/windows/c5s-persistence/faed777/evidence-manifest.json` / `00a3403d4c8e87e5cd26da94397123603fca6c824d89f000f271b1684e826a55`; `artifacts/windows/c5s-wa02-package-completion/9abd9e1/evidence-manifest.json` / `32ff55f0e3809d3904f620e346f130b927dea009ebf3d8186ead741e88139891` | — |
| WA-03 | `R2` | `multi-document-project-workspace` | `06523be69700d99b3cd32e8e564d719cdd915679` (`2.1a/2.4a/2.8a/4.3a/4.4a`) | `faed77761b39f273563bd39dc51f5e39cd620cf5` | `SOURCE_MERGED_PASS` | `artifacts/windows/c5s-persistence/faed777/evidence-manifest.json` / `00a3403d4c8e87e5cd26da94397123603fca6c824d89f000f271b1684e826a55` | — |
| WA-04 | `R1` | `language-resource-portability` | `356f6e045b8dddf074bafadbbf29c1a64026c95b` (non-TM Resource/Termbase source implementation); `5a857c91aaf811cb5f1a5e9a9fda4e009c1da9e7` (`4.4a` terminal reproof before success receipt) | `5a857c91aaf811cb5f1a5e9a9fda4e009c1da9e7` | `SOURCE_COMMITTED` | `artifacts/windows/c5s-persistence/faed777/evidence-manifest.json` / `00a3403d4c8e87e5cd26da94397123603fca6c824d89f000f271b1684e826a55`; `artifacts/windows/c5s-resource-receipt/5a857c9/evidence-manifest.json` / `492d17ec5ae1c16b94c7a9f2cfd67dac09a18288cc2d641a976d2c3ebba11cc1` | — |
| WA-05 | `R1` | `tmx-context-interchange` | `c7041398f5d8f6d130a35583ac735292d10351d8` (`2.3a/3.4a/3.5a`; `5.3a`等待WA-06) | `faed77761b39f273563bd39dc51f5e39cd620cf5` | `SOURCE_COMMITTED` | `artifacts/windows/c5s-persistence/faed777/evidence-manifest.json` / `00a3403d4c8e87e5cd26da94397123603fca6c824d89f000f271b1684e826a55` | — |
