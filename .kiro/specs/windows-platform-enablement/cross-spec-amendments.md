...
| WA-02 | `R1` | `collaborative-job-chunks` | `a0cde80aa18958b60490f60d6f0a56f24821e68b` (`1.3a/1.4a/3.2a`); `91b0039651401113175c9ed5b17fcd4fcd57e4cc` (`4.4a/4.5a` application-edge integration) | `faed77761b39f273563bd39dc51f5e39cd620cf5` | `SOURCE_COMMITTED` | `artifacts/windows/c4s-wa02-startup/a0cde80/evidence-manifest.json` / `d68561c1abc061528ecfc503d7c5d0d395cf8881a64425f00ccd6d200dad2157`; `artifacts/windows/c5s-persistence/faed777/evidence-manifest.json` / `00a3403d4c8e87e5cd26da94397123603fca6c824d89f000f271b1684e826a55` | — |
