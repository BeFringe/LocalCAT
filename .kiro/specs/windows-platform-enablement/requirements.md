...
[ADR-028](../../steering/adr/adr-028.md) 定义普通桌面产品边界，Requirement 10–12 承载普通 frozen 的发行与验收要求。Requirement 1–9 的 source 数据与业务合同、原 source/W3 构建前完成事实及证据范围保留。旧版本可从 `6531b1e` 追溯，旧 W3 正文不作为本路线的活动指令。
