...
2. **约束服务产品目标** — 实施遵守当前已批准边界；当威胁范围、用户价值或维护成本改变，项目 owner 可以明确修订或取代约束。旧 ADR 不是不可重估的产品目标，已批准的简化不应被旧检查项重新阻断。交付取舍见 `delivery-boundaries.md`。
...
**红线（Red Line）：** 当前批准范围内的硬约束。未经授权的越界属于违规；经项目 owner 批准的范围收窄或取代属于正常演进，应明确更新适用关系。
