...
_KNOWN_NON_PARSER_GRAMMAR_MODULES = frozenset(
    {
        ...
        "tools.prepare_windows_frozen_entry_inputs",
        "tools.record_windows_frozen_entry_probe",
        "tools.record_windows_frozen_entry_probe_prebuild",
        "tools.run_posix_characterization",
        "tools.run_windows_c3b_capability_gate",
        "tools.run_windows_documented_publish_evidence",
        "tools.run_windows_evidence_harness_smoke",
        "tools.validate_windows_frozen_custom_entry_no_go",
        "tools.validate_windows_release",
